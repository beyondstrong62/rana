          ...
          <Col md={7}>
            <Fade duration={3000}>
              <p className="home-about-body">
                My name is <b className="purple">Rana Sujeet Kumar </b> 
                  and I am a <b className="purple">Computer Science and Engineering </b> 
                    student at <b className="purple">C.v. Raman Global University </b>
                      in Odisha, India.
                <br />
                <br />
                  ...
                  <b className="purple">
                    {" "}
                    Java,J2EE, C, C++, Python, HTML, CSS,  and JavaScript.{" "}
                  </b>
                <br />
                <br />
                I also have experience working with frameworks and libraries such as &nbsp;
                  ...
                  <b className="purple">
                    {" "}
                    NodeJS, ReactJS, Machine/Deep Learning, CNN, Pandas, and NumPy.{" "}
                  </b>
                <br />
                <br />
